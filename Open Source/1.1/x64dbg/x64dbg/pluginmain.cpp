...
void SocketServerThread(SOCKET *sock, MyStruct *ptr)
{
	while (TRUE)
	{
		...
		if (recv_flag != 0 && recv_struct->ControlId != 0)
		{
...
#ifdef _WIN64
			// 读取寄存器
			case GetRaxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRax(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRbxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRbx(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRcxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRcx(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRdxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRdx(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRsiRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRsi(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetSilRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetSil(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRdiRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRdi(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetDilRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetDil(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRbpRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRbp(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetBplRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetBpl(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRspRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRsp(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetSplRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetSpl(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetRipRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetRip(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR8RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR8(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR8dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR8d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR8wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR8w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR8bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR8b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR9RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR9(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR9dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR9d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR9wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR9w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR9bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR9b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR10RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR10(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR10dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR10d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR10wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR10w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR10bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR10b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR11RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR11(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR11dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR11d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR11wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR11w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR11bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR11b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR12RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR12(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR12dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR12d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR12wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR12w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR12bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR12b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR13RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR13(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR13dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR13d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR13wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR13w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR13bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR13b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR14RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR14(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR14dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR14d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR14wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR14w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR14bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR14b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR15RegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR15(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR15dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR15d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR15wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR15w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case GetR15bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::GetR15b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			// 设置寄存器
			case SetRaxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRax(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRbxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRbx(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRcxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRcx(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRdxRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRdx(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRsiRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRsi(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetSilRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetSil(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRdiRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRdi(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetDilRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetDil(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRbpRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRbp(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetBplRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetBpl(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRspRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRsp(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetSplRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetSpl(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetRipRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetRip(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR8RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR8(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR8dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR8d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR8wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR8w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR8bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR8b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR9RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR9(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR9dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR9d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR9wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR9w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR9bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR9b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR10RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR10(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR10dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR10d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR10wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR10w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR10bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR10b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR11RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR11(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR11dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR11d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR11wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR11w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR11bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR11b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR12RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR12(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR12dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR12d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR12wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR12w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR12bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR12b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR13RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR13(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR13dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR13d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR13wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR13w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR13bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR13b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR14RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR14(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR14dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR14d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR14wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR14w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR14bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR14b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR15RegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR15(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR15dRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR15d(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR15wRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR15w(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
			...
			case SetR15bRegisterDef:
			{
				BOOL ref_flag = RegisterApi::SetR15b(*recv_struct, *sock);
				if (FALSE == ref_flag)
				{
					closesocket(*sock);
				}
...
void PrintLogo()
{
	...
	_plugin_logprintf("------------------------------------------\n");
	_plugin_logprintf("Build Date: April 30, 2024\n");
	_plugin_logprintf("Plugin Version: 1.1.0 (x64)\n");
